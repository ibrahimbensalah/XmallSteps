...
namespace Xania.Calculation.Designer.Controls
{
    ...
    public static class GraphicsExtensions
    {
        ...
        public static void DrawRoundRectangle(this Graphics g, System.Drawing.Pen pen, int x, int y,
          int width, int height, int radius) 
        { 
            float fx = Convert.ToSingle(x);
            float fy = Convert.ToSingle(y); 
        ...
        private static GraphicsPath GetRoundedRect(this Graphics g, RectangleF baseRect, 
           float radius) 
        {
        ...
        private static GraphicsPath GetCapsule(this Graphics g, RectangleF baseRect) 
        { 
            float diameter; 
            RectangleF arc; 
            GraphicsPath path = new System.Drawing.Drawing2D.GraphicsPath(); 
